...
<nav style="background-color:#272727;">
        <div class="logo">
            <a href="/"><img src={{URL::asset('images/akla.png')}} alt="logo" /></a>
        </div>
        <ul class="nav-links">
    ...
    <table class="table">
        ...
        <tbody>
             <tr>
                ...
                <td>{{$details[0]->street}}</td>
                <td>{{$details[0]->building_number}}</td>
                <td>{{$details[0]->department_number}}</td>
                <td>{{$details[0]->phone_number}}</td>
                <td>{{$details[0]->Popular_Mark}}</td>
                </tr>
         </tbody>
    </table>
</div>
<div style="display:flex ;  justify-content: space-around;">
   <a class="btn btn-danger" href="{{ url('/delivary/edit/'.Auth::id())}}" >  Print Details </a>
