                ...
                @if($item->user_id != $currentUID)
                     <table class="table">
                        <thead>
                            ...
                            <th>Meal Price</th>
                            <th><a class="btn btn-primary" href="{{route('deliveryDetails', $item->user_id)}}"> Delivary Details </a></th>
                            <th><a class="btn btn-danger" href="{{route('end', $item->user_id)}}"> End Order </a></td></th>
                         </thead>
                        <tbody>
                             <tr>
                                <td>{{$item->user_id}}</td>
