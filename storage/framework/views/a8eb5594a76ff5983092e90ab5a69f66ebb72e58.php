...
">
    ...
    <div class="card" style="width:fit-content;">
        ...
        <div class="card-body">
            <form  action="<?php echo e(url('/update-delivery/'.Auth::id())); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="row mb-4">
    <div class="col">
      <div class="form-outline">
      <input value="<?php echo e($Delivery->city); ?>" type="string" id="city" name="city" class="form-control" required="">
      <label class="form-label" for="form6Example1">City</label>
      </div>
    </div>
    <div class="col">
      <div class="form-outline">
        <input value="<?php echo e($Delivery->district); ?>" type="string" id="district" name="district" class="form-control" required="">
  ...
  <input value="<?php echo e($Delivery->street); ?>" type="string" id="street" name="street" class="form-control" required="">
    <label class="form-label" for="form6Example3">Street</label>
  </div>

  <!-- Text input -->
  <div class="form-outline mb-4">
  <input value="<?php echo e($Delivery->building_number); ?>" type="number" id="building_number" name="building_number" class="form-control" required="">
    <label class="form-label" for="form6Example4">Building Number</label>
  </div>

  <!-- Email input -->
  <div class="form-outline mb-4">
  <input value="<?php echo e($Delivery->department_number); ?>" type="number" id="department_number" name="department_number" class="form-control" required="">
    <label class="form-label" for="form6Example5">Department Number</label>
  </div>

  <!-- Number input -->
  <div class="form-outline mb-4">
  <input value="<?php echo e($Delivery->phone_number); ?>" type="string" id="phone_number" name="phone_number" class="form-control" required="">
    <label class="form-label" for="form6Example6">Phone Number</label>
  </div>

  <div class="form-outline mb-4">
  <input value="<?php echo e($Delivery->Popular_Mark); ?>" type="string" id="Popular_Mark" name="Popular_Mark" class="form-control" required="">
     <label class="form-label" for="form6Example6">Popular Mark</label>
  </div>
  
  <!-- Message input -->
  <div class="form-outline mb-4">
    <textarea value="<?php echo e($Delivery->delivery_time); ?>" class="form-control" id="form6Example7" name="delivery_time" rows="4"></textarea>
...
<?php /**PATH E:\Internship\NajahNow Internship\restaurant-Ahmed-branch\resources\views/update-delivery-details.blade.php ENDPATH**/ ?>