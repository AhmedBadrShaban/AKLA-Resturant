...
<nav class="menuNav">
    <div class="container">
        ...
        <div class="active">
            <a href="<?php echo e(route('Product.MyCart')); ?>" aria-expanded="true">Checkout</a>
        </div>
...
<div class="container">
               <div class="order-summary">
                        ...
                        <div class="btn main-btn"> <a href="<?php echo e(url('stripe')); ?>"> Pay online </a> </div>
                        <div class="btn main-btn"> <a href="<?php echo e(route('Order.send', Auth::id())); ?>"> Pay on Delivery </a> </div>
...
</body><?php /**PATH E:\Internship\NajahNow Internship\restaurant-Ahmed-branch\resources\views/checkout.blade.php ENDPATH**/ ?>